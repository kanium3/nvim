...
vim.api.nvim_set_keymap("n", "<leader>gR", "<cmd>TroubleToggle lsp_references<cr>", { silent = true, noremap = true })
-- ZenMode
...
-- icon-picker
vim.keymap.set("n", "<Leader><Leader>i", "<cmd>IconPickerNormal<cr>", { silent = true, noremap = true })
vim.keymap.set("n", "<Leader><Leader>y", "<cmd>IconPickerYank<cr>", { silent = true, noremap = true })
--vim.keymap.set("i", "<C-i>", "<cmd>IconPickerInsert<cr>", { silent = true, noremap = true })
-- renamer
...
vim.api.nvim_set_keymap(
	"n",
	"<leader>gg",
	':lua require("plug_conf.toggleterm").lazygit_toggle()<CR>',
	{ silent = true, noremap = true }
)
...
vim.api.nvim_set_keymap("n", "<leader>do", ":DocsViewToggle<CR>", { noremap = true, silent = true })
